...
class ItemHelper {
    ...
    public Cursor getSearchItemsList(String category, String search) {
        ...
        if((category.equals("") && search.equals(""))){
            sql="SELECT _id, catagory, code, description FROM items";
        }else if(category.equals("")){
            sql="SELECT _id, catagory, code, description FROM items WHERE (description LIKE '%"+search+"%' OR code LIKE '%" + search + "%')";
        }else if(search.equals("")){
            sql="SELECT _id, catagory, code, description FROM items WHERE (catagory LIKE '%"+category+"%')";
        }else {
            sql = "SELECT _id, catagory, code, description FROM items WHERE (catagory LIKE '%" + category + "%' AND (description LIKE '%" + search + "%' OR code LIKE '%" + search + "%'))";
        }
